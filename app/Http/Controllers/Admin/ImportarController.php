...
class ImportarController extends Controller
{
  ...
  {
    $breadcrumbs = [
      ["link" => "/dashboard", "name" => "Home"], ["name" => "Importar Pagos"]
    ];
    return view('admin.imports.payments', compact('breadcrumbs'));
  }

  public function people(): View
  {
    $breadcrumbs = [
      ["link" => "/dashboard", "name" => "Home"], ["name" => "Importar Personas"]
    ];
    return view('admin.imports.people', compact('breadcrumbs'));
  }

  public function judicials(): View
  {
    $breadcrumbs = [
      ["link" => "/dashboard", "name" => "Home"], ["name" => "Importar Judiciales"]
    ];
    return view('admin.imports.judicials', compact('breadcrumbs'));
  }
  ...
  public function uploadPeople(Request $request)
  {
    ...
    try {
      $personasExcel = Excel::toCollection(new PaymentsImport(), $request->file('archivo'));
  ...
  public function uploadPayments(Request $request): JsonResponse
  {
    $request->validate([
      'archivo' => 'required|mimes:xls,xlsx',
    ]);
  ...
  public function uploadAssetDiscount(Request $request)
  {
    $request->validate([
      'archivo' => 'required|mimes:xls,xlsx',
    ]);
  ...
  public function uploadJudicials(Request $request): JsonResponse
  {
    $request->validate([
      'archivo' => 'required|mimes:xls,xlsx',
    ]);
