...
class Pago extends Model
{
  ...
  protected $appends = ['person_full_name'];
  ...
  public function getFAfilAttribute()
  {
    return $this->fafiliacion
      ? Carbon::parse($this->fafiliacion)->format('d/m/Y')
      : null;
  }
  ...
  public function getFDevAttribute()
  {
    return $this->fdevengue
      ? Carbon::parse($this->fdevengue)->format('d/m/Y')
      : null;
  }
  ...
  public function pathBoleta()
  {
    ...
    return route('reports.byVoucher', $url_decode);
  }
}
