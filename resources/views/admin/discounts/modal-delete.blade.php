<div id="delete-modal-{{ $discount->id }}" class="modal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-body p-5 grid gap-5">
        ...
        <div class="mt-5 flex flex-col-reverse sm:flex-row gap-2 justify-items-stretch sm:justify-end">
          ...
          <button wire:click="destroy({{ $discount->id }})" type="button" class="btn btn-danger">Si, eliminar</button>
        </div>
      </div>
    </div>
  </div>
