...
@section('head', 'Importar Personas')

@section('subcontent')

<div>
  <div class="intro-x mt-10 flex items-center h-10">
    <h1 class="text-xl font-medium truncate mr-5">Importar Personas</h1>
  </div>

  <div class="mt-5 w-full border-b-2 border-gray-300 dark:border-slate-700 flex flex-col justify-center items-center gap-5" x-data="ImportPeople" x-init"init">
