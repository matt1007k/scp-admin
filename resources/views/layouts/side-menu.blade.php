...
@section('content')
    ...
    <div class="w-full">
        <div class="wrapper-box flex {{-- gap-5 --}}">
            ...
            <nav class="side-nav">
                <div class="uppercase text-gray-300 pb-5 border-b border-slate-300">Menú</div>
                <ul>
                            ...
                            @can($menu['can'], $menu['model'])
                                <li>
                                    <a href="{{ isset($menu['sub_menu']) ? 'javascript:;' : route($menu['route']) }}"
                                        class="{{ (isset($menu['sub_menu']) ? request()->is($menu['route'] . '*') : $menu['route'] === Route::currentRouteName()) ? 'side-menu side-menu--active' : 'side-menu' }}">
                                        ...
                                        <div class="side-menu__title">
                                            ...
                                            @if (isset($menu['sub_menu']))
                                                <div
                                                    class="side-menu__sub-icon {{ request()->is($menu['route'] . '*') ? 'transform rotate-180' : '' }}">
                                                ...
                                                @can($submenu['can'], $submenu['model'])
                                                    <li>
                                                        <a href="{{ route($submenu['route']) }}"
                                                            class="{{ $submenu['route'] === Route::currentRouteName() ? 'side-menu side-menu--active' : 'side-menu' }}">
                                                            <div class="side-menu__icon">
