<div class="grid gap-6" x-data="voucherReport" x-init="mount" x-cloak>
        ...
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.data('voucherReport', () => ({
                ...
                viewPDF() {
                    ...
                    window.open(`/reporte/boleta/${params_code}`, "_blank");
                },
                downloadPDF() {
                    let params = {
                        mes: this.month,
                    ...
                    const params_code = window.btoa(JSON.stringify(params));
                    axios({
                        url: `/reporte/boleta/${params_code}`,
                        method: "GET",
                        ...
                        const name_file =
                            `boleta-${this.person.codigo_modular}-${this.year}-${this.month}.pdf`;
                        link.href = url;
