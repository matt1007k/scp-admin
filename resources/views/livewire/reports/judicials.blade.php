<div class="grid gap-6" x-data="yearReport" x-init="mount" x-cloak>
        ...
        <div class="grid gap-5">
                        ...
                        <ul class="shadow-lg rounded-sm box absolute z-50 min-w-[200px]" x-show="openSearchPerson"
                            ...
                            @forelse($people as $person)
                                <li class="py-3 px-4 hover:bg-gray-100 dark:hover:bg-slate-800 cursor-pointer"
                                    ...
                                    <p class="text-gray-500 dark:text-gray-300">Número de Documento: {{ $person->dni }}
                                    </p>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-300"
                                    x-text="getModularCode(person.codigo_modular)"></p>
                            </div>
                            <div>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary">
                    ...
                    <span wire:loading wire:target="judicial">Buscando...</span>
                    <span>Buscar</span>
                </button>
            </div>
        </div>
    ...
    @if ($isSearch)
        <div class="grid gap-7">
            ...
            @if ($judicial)
                <div
                    class="px-4 py-4 rounded-lg border border-gray-300 dark:border-slate-800 grid items-center grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="col-span-1 md:col-span-1">
                        <h5 class="font-bold text-xl">{{ $judicial->anio }}</h5>
                        <p class="text-gray-500 dark:text-gray-300">{{ $judicial->persona->full_name }}</p>
                    </div>
            ...
            Alpine.data('yearReport', () => ({
                ...
                downloadPDF() {
                    ...
                    axios({
                        ...
                        const name_file =
                            `judicial-${this.person.codigo_modular}-${this.year}-${this.month}.pdf`;
                        link.href = url;
