<div class="grid gap-6" x-data="yearsReport" x-init="mount" x-cloak>
        ...
        <div class="grid gap-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="grid gap-1">
                    ...
                    <select id="yearFrom" wire:model="yearFrom"
                        class="form-control border @error('yearFrom') border-red-500 @enderror">
                ...
                <div class="grid gap-1">
                    ...
                    <select id="yearTo" wire:model="yearTo"
                        class="form-control border @error('yearTo') border-red-500 @enderror">
                        @foreach ($years as $year)
                            <option value="{{ $year->anio }}">{{ $year->anio }}</option>
                        @endforeach
                    </select>
            ...
            Alpine.data('yearsReport', () => ({
                ...
                downloadPDF() {
                    ...
                    axios({
                        ...
                        const name_file =
                            `${this.person.codigo_modular}-${this.yearFrom}-${this.yearTo}.pdf`;
                        link.href = url;
