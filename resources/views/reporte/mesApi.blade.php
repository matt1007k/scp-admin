...
<head>
  ...
  <title>Boleta de Pago Electrónica</title>
...
<body>
  <header>
    <div class="head-page">
      <img src="{{public_path().'/img/logo-drea.png'}}" width="70" alt="">
      <div class="title">
    ...
    <table class="position-relative w-100">
      <thead>
      ...
      <tbody>
        ...
        <tr>
          <td class="text-left fs-header-sm border-sm">
            ...
            <p>
              <span>
                Inicio: {{ $pago->fecha_in }}
              </span>
              <span>
                Termino: {{ $pago->fecha_fi }}
              </span>
            </p>
          </td>
          <td class="text-left fs-header-sm border-sm">
        ...
        <tr>
          ...
          <td class="text-left fs-header-sm border-sm">
            <b>TIPO PENSION</b>
            <p class="text-uppercase">{{ $pago->tipo_pension }}</p>
          </td>
          @endisset
    ...
    <table class="w-100">
      <tbody>
        <tr>
          ...
          <td class="text-right">
            <img class="position-absolute" style=" right: 0; border: 1px solid #000;" src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(90)->generate($pago->pathBoleta())) !!} ">
          </td>
